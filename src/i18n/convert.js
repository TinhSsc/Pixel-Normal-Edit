...
const MASTER = {
  "onboarding.welcome.title": { en: "Welcome to Pixel Normal Edit!", vi: "Chào mừng bạn đến với Pixel Normal Edit!" },
  "onboarding.welcome.desc": { en: "Pixel Normal Edit is a pixel art editor and image tool that runs entirely in your browser — no install, no upload to server. Everything happens on your device.", vi: "Pixel Normal Edit là công cụ chỉnh sửa ảnh pixel art và xử lý ảnh chạy ngay trên trình duyệt — không cần cài đặt, không cần tải file lên máy chủ. Mọi thứ diễn ra ngay trên thiết bị của bạn." },
  "onboarding.welcome.feature1": { en: "Draw pixel art with a professional toolset", vi: "Vẽ pixel art với bộ công cụ chuyên nghiệp" },
  "onboarding.welcome.feature2": { en: "Convert, compress, resize, crop, rotate images in a few clicks", vi: "Chuyển đổi, nén, resize, crop, xoay ảnh chỉ với vài cú click" },
  "onboarding.welcome.feature3": { en: "Split video/GIF into frames and reassemble into animation", vi: "Tách video/GIF thành từng khung hình và ghép lại thành animation" },
  "onboarding.welcome.question": { en: "Do you already know how to use Pixel Normal Edit?", vi: "Bạn đã biết sử dụng Pixel Normal Edit chưa?" },
  "onboarding.welcome.optionGuide": { en: "I don't know yet – Guide me", vi: "Tôi chưa biết – Hướng dẫn tôi" },
  "onboarding.welcome.optionSkip": { en: "I already know – Skip", vi: "Tôi biết rồi – Bỏ qua" },
  "onboarding.welcome.sub": { en: "It only takes about 3 minutes to get familiar with everything. You can skip anytime with the Esc key.", vi: "Chỉ mất khoảng 3 phút để làm quen với mọi thứ. Bạn có thể bỏ qua bất cứ lúc nào bằng phím Esc." },
  "onboarding.phase0.name": { en: "Welcome", vi: "Chào mừng" },
  "onboarding.phase0.description": { en: "Welcome & invitation to onboarding", vi: "Chào mừng & lời mời hướng dẫn" },
  "onboarding.phase0.step000.title": { en: "👋 Welcome to Pixel Normal Edit!", vi: "👋 Chào mừng bạn đến với Pixel Normal Edit!" },
  "onboarding.phase0.step000.body": { en: "Pixel Normal Edit is a pixel art editor and image tool that runs entirely in your browser. You can draw pixel art, convert/compress/resize/crop/rotate images, and split video/GIF into frames then reassemble into animation.", vi: "Pixel Normal Edit là công cụ chỉnh sửa ảnh pixel art và xử lý ảnh chạy ngay trên trình duyệt. Bạn có thể vẽ pixel art, chuyển đổi/nén/resize/crop/xoay ảnh, và tách video/GIF thành khung hình rồi ghép lại thành animation." },
  "onboarding.phase0.step001.title": { en: "🎯 Quick guide – 3 minutes", vi: "🎯 Hướng dẫn nhanh – 3 phút" },
  "onboarding.phase0.step001.body": { en: "We will walk you through each important area of the app using guide cards like this. Use Next to continue, Back to go back, Skip or Esc to exit anytime. The progress bar at the bottom shows where you are.", vi: "Chúng tôi sẽ dẫn bạn qua từng khu vực quan trọng của ứng dụng bằng các ô vuông hướng dẫn như thế này. Dùng Next để đi tiếp, Back để quay lại, Skip hoặc Esc để thoát bất cứ lúc nào. Thanh tiến trình ở dưới cùng cho biết bạn đang ở đâu." },
  "onboarding.buttons.next": { en: "Next", vi: "Tiếp theo" },
  "onboarding.buttons.back": { en: "Back", vi: "Quay lại" },
  "onboarding.buttons.skip": { en: "Skip", vi: "Bỏ qua" },
  ...
  "download.chooseDriveLogin": { en: "Sign in to Drive", vi: "Đăng nhập Drive" },
  "download.chooseFolder": { en: "Choose folder", vi: "Chọn thư mục" },
  "download.destination": { en: "Destination", vi: "Nơi lưu" },
  "download.download": { en: "Download to device", vi: "Tải xuống máy" },
  "download.drive": { en: "Google Drive", vi: "Google Drive" },
  "download.driveLoggedIn": { en: "Signed in to Google Drive", vi: "Đã đăng nhập Google Drive" },
  "download.driveNotLoggedIn": { en: "Not signed in to Google Drive", vi: "Chưa đăng nhập Google Drive" },
  "download.driveUploaded": { en: "Uploaded to Google Drive", vi: "Đã tải lên Google Drive" },
  ...
  "download.folder": { en: "Save to folder", vi: "Lưu vào thư mục" },
  "download.folderNotSet": { en: "No local folder selected", vi: "Chưa chọn thư mục cục bộ" },
  "download.folderSelected": { en: "Folder:", vi: "Thư mục:" },
  ...
  "status.savedToFolder": { en: "Saved to folder: {0}", vi: "Đã lưu vào thư mục: {0}" },
  ...
  "tooltip.downloadDest": { en: "Download to device", vi: "Tải xuống máy" },
