// Updated i18n.js — shortened labels, keyboard shortcuts removed from tool tooltips
export const dictionary = {
  vi: {
    ...
    "tooltip.replaceBg": "Thay ảnh nền",
    "tooltip.flattenBg": "Gộp nền",
    "tooltip.compress": "Nén ảnh",
    "tooltip.upload": "Mở",
    "tooltip.uploadFull": "Mở ảnh hoặc JSON",
    "tooltip.compressFull": "Nén ảnh",
    "tooltip.export": "Lưu ảnh",
    "tooltip.exportFull": "Lưu vào máy",
    "tooltip.exportPng": "PNG",
    "tooltip.exportJpeg": "JPEG",
    "tooltip.exportWebp": "WEBP",
    "tooltip.exportJson": "Dự án (.json)",
    "tooltip.swapColors": "Đảo màu",
    "tooltip.primaryColor": "Màu chính",
    "tooltip.secondaryColor": "Màu phụ",
    "tooltip.toggleNav": "Điều hướng",
    "tooltip.gradientMode": "Gradient Alpha",
    "tooltip.showGrid": "Hiện lưới",
    "tooltip.mirrorMode": "Đối xứng",
    "tooltip.gridSize": "Đổi kích thước canvas",
    "tooltip.gradDir": "Hướng gradient",
    "tooltip.rulerMode": "Thước đo pixel",
    "label.rotateOptions": "Chế độ xoay",
    "option.rotateSize": "Xoay canvas",
    "option.rotatePixel": "Chỉ xoay pixel",
    "tooltip.pencilSize": "Cỡ bút",
    "tooltip.eraserSize": "Cỡ tẩy",
    ...
    "tooltip.renameTab": "Click đúp để đổi tên",
    "confirm.closeTab": "Bạn có chắc muốn đóng tab này? Dữ liệu chưa lưu sẽ bị mất.",

    "tool.pixel-pen": "Pen Pixel",
    "tool.highlight-pen": "Highlight Pen",
    "tool.blend-brush": "Blend Brush",
    "tool.spray-pen": "Bút phun",
    "tool.eraser": "Tẩy",
    "tool.picker": "Hút màu",
    "tool.fill": "Đổ màu",
    "tool.magicEraser": "Tẩy màu",
    ...
    "tool.crop": "Cắt xén ảnh",
    "tool.replaceColor": "Thay thế màu",
    "tool.outline": "Viền",
    "tool.line": "Đường",
    "tool.rect": "Chữ nhật",
    "tool.circle": "Tròn",
    ...
    "tooltip.spraySize": "Kích thước vùng phun",
  ...
  en: {
    ...
    "tooltip.replaceBg": "Replace Background",
    "tooltip.flattenBg": "Flatten Background",
    "tooltip.compress": "Compress Image",
    "tooltip.upload": "Open",
    "tooltip.uploadFull": "Open Image / JSON",
    "tooltip.compressFull": "Compress Image",
    "tooltip.export": "Save Image",
    "tooltip.exportFull": "Save to Device",
    "tooltip.exportPng": "PNG",
    "tooltip.exportJpeg": "JPEG",
    "tooltip.exportWebp": "WEBP",
    "tooltip.exportJson": "Project (.json)",
    "tooltip.swapColors": "Swap Colors",
    "tooltip.primaryColor": "Primary Color",
    "tooltip.secondaryColor": "Secondary Color",
    "tooltip.toggleNav": "Navigation",
    "tooltip.gradientMode": "Gradient Alpha",
    "tooltip.showGrid": "Show Grid",
    "tooltip.mirrorMode": "Mirror",
    "tooltip.gridSize": "Resize Canvas",
    "tooltip.gradDir": "Gradient Direction",
    ...
    "btn.stopTask": "Stop",
    "btn.newCanvas": "New",
    "tooltip.newCanvas": "Create new tab",
    ...
    "tool.replaceColor": "Replace Color",
    ...
    "tooltip.spraySize": "Spray area size",
    "tooltip.sprayDensity": "Pixels per spray tick",
    ...
    "drive.login": "Login to Drive",
    "drive.logout": "Logout Drive",
