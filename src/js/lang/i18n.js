...
export const dictionary = {
  vi: {
    ...
    "tooltip.gradDir": "Chọn hướng đổ màu (dọc, ngang, chéo, tỏa tròn...)",
    "label.rotateOptions": "Tùy chọn xoay (khi không vuông)",
    "option.rotateSize": "Xoay luôn size pixel",
  ...
  en: {
    ...
    "tooltip.gradDir": "Select gradient direction (vertical, horizontal, diagonal, radial...)",
    "label.rotateOptions": "Rotate options (non-square)",
    "option.rotateSize": "Rotate grid size",
