      ...
      <div className="tool-group">
        ...
        <div className="tool-grid">
          ...
          <div className="tool-with-popup-bottom">
            ...
            <div className="popup-bridge-bottom">
              <div className="tool-popup">
                <label data-i18n="tooltip.spraySize"><span data-i18n="label.spraySize">Kích thước</span></label>
                <input type="number" id="sprayPenSize" min="1" max="50" defaultValue="10" />
                <label data-i18n="tooltip.sprayDensity"><span data-i18n="label.sprayDensity">Mật độ</span></label>
      ...
      <div className="tool-group">
        ...
        <div className="tool-grid">
          ...
          <div className="tool-with-popup-bottom" data-variants="replace-color">
            ...
            <div className="popup-bridge-bottom">
              <div className="tool-popup">
                <label data-i18n="tooltip.replaceTolerance"><span data-i18n="magicEraser.tolerance">Sai lệch màu</span></label>
